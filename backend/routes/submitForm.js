...
router.post("/",
    ...
    check("step1.*.value", "Step 1 value - string error").isString(),
    ...
    check("step10.*.value", "Step 10 data point - string error").isString(),
    check("step10.*.checked", "Step 10 checked - bool error").isBoolean(),
    check("step11", "Step 11 - object error").isObject(),
    check("step11.value1", "Step 11 value1 - string error").isString(),
    check("step11.value2", "Step 11 value2 - string error").isString(),
    ...
    , async function (req, res, next) {
        ...
        if (userExists.length > 0) {
            ...
            const step4Row1 = [];
            const step4Row2 = [];
            const step5Row1 = [req.body.step5.value1];
            const step5Row2 = [req.body.step5.value2];
